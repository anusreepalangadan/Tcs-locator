...
class LocationDetailsScreenState extends State<LocationDetailsScreen> {
  ...
  Widget build(BuildContext context) {
      ...
      body:
       ...
       child: FlutterMap(
            options: MapOptions(
              ...
              initialCenter: latLng.LatLng(widget.location.geometry!['lat'], widget.location.geometry!['lng']),
              minZoom: 3.2,
            ),
            children: [
              TileLayer(
    ...
    markers: [
        Marker(
          point: latLng.LatLng(widget.location.geometry!['lat'], widget.location.geometry!['lng']),
          width: 100,
          height: 100,
